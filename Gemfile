...
ruby "2.4.2"                  # Ruby 2.4.2p198, 14 Sep 2017
gem 'rails', '5.1.4'          # Full-stack web framework, Sep 08 2017
gem 'bcrypt', '3.1.11'        # Safely handling passwords, Mar 06 2016
gem 'faker', '1.8.5'          # Easily generating fake data, Dec 06 2017
gem 'carrierwave', '1.2.1'    # Upload files in Ruby applications, Oct 04 2017
gem 'mini_magick', '4.8.0'    # Manipulate images with minimal use of memory, Jul 06 2017
gem 'fog-aws', '2.0.0'        # Provider to use the Amazon Web Services, Nov 28 2017
gem 'will_paginate', '3.1.6'  # Performing paginated queries, Jun 07 2017
gem 'bootstrap-will_paginate', '1.0.0' # Format the html to match Bootstrap, Apr 16 2017
